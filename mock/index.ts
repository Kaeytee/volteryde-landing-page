import { NavLink, Step } from "@/types";
 ...
 export  const steps: Step[] = [
    {
      number: "1",
      title: "Download The Voltryde App",
      description: "Get Voltryde on Google Play or the App Store and sign up in minutes to start your electric bus journey.",
    },
    {
      number: "2",
   ...
   export const navLinks: NavLink[] = [
    { label: 'Voltryde', href: '/' },
    { label: 'How Voltryde Works', href: '/#how-it-works' },
    { label: 'Get Voltryde', href: '/#get-voltryde' },
  ];
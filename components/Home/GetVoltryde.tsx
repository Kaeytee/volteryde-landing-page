...
export default function GetVoltryde() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Join the move toward greener transportation. Download Voltryde and
        ...
        >
          ...
          <motion.div variants={buttonVariants}>
            <Link href="#">
              <motion.button
                className="group relative flex items-center justify-center gap-3 bg-gradient-to-r from-black to-black text-white px-6 py-3 rounded-xl shadow-xl border border-black/20 overflow-hidden"
                whileHover={{ 
                  scale: 1.05,
